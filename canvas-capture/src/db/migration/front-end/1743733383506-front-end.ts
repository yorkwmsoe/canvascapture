...
export class FrontEnd1743733383506 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "answer" ("date_last_received_from_canvas" datetime NOT NULL DEFAULT (datetime('now')), "id" numeric PRIMARY KEY NOT NULL, "text" text NOT NULL, "html" text NOT NULL, "quizSubmissionQuestionId" numeric)`
        )
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "temporary_file" ("date_last_received_from_canvas" datetime NOT NULL DEFAULT (datetime('now')), "id" numeric PRIMARY KEY NOT NULL, "uuid" varchar NOT NULL, "folder_id" numeric NOT NULL, "display_name" text NOT NULL, "filename" text NOT NULL, "content-type" text NOT NULL, "url" text NOT NULL, "size" numeric NOT NULL, "created_at" date NOT NULL, "updated_at" date NOT NULL, "unlock_at" date NOT NULL, "locked" boolean NOT NULL, "hidden" boolean NOT NULL, "lock_at" date NOT NULL, "hidden_for_user" boolean NOT NULL, "visibility_level" text NOT NULL, "thumbnail_url" text NOT NULL, "modified_at" date NOT NULL, "mime_class" text NOT NULL, "media_entry_id" text NOT NULL, "locked_for_user" boolean NOT NULL, "lock_explanation" text NOT NULL, "preview_url" text, "discussion_topic_id" numeric, "lockInfoAssetString" text, CONSTRAINT "REL_fea9cade6fd5f1819602503a8e" UNIQUE ("lockInfoAssetString"), CONSTRAINT "FK_fea9cade6fd5f1819602503a8e4" FOREIGN KEY ("lockInfoAssetString") REFERENCES "lock_info" ("asset_string") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_b2fbfdda9b23492e4816b5f3f01" FOREIGN KEY ("discussion_topic_id") REFERENCES "discussion_topic" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`
        )
        await queryRunner.query(
            `INSERT INTO "temporary_file"("date_last_received_from_canvas", "id", "uuid", "folder_id", "display_name", "filename", "content-type", "url", "size", "created_at", "updated_at", "unlock_at", "locked", "hidden", "lock_at", "hidden_for_user", "visibility_level", "thumbnail_url", "modified_at", "mime_class", "media_entry_id", "locked_for_user", "lock_explanation", "preview_url", "discussion_topic_id", "lockInfoAssetString") SELECT "date_last_received_from_canvas", "id", "uuid", "folder_id", "display_name", "filename", "content-type", "url", "size", "created_at", "updated_at", "unlock_at", "locked", "hidden", "lock_at", "hidden_for_user", "visibility_level", "thumbnail_url", "modified_at", "mime_class", "media_entry_id", "locked_for_user", "lock_explanation", "preview_url", "discussion_topic_id", "lockInfoAssetString" FROM "file"`
        )
        ...
        await queryRunner.query(
            `CREATE TABLE "temporary_answer" ("date_last_received_from_canvas" datetime NOT NULL DEFAULT (datetime('now')), "id" numeric PRIMARY KEY NOT NULL, "text" text NOT NULL, "html" text NOT NULL, "quizSubmissionQuestionId" numeric, CONSTRAINT "FK_0f70b0822f92a61a03f09ec4868" FOREIGN KEY ("quizSubmissionQuestionId") REFERENCES "quiz_submission_question" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`
        )
        await queryRunner.query(
