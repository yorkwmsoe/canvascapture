...
export async function getComments(domain: string, course: number, quiz_id: number, quiz_submission_id: number, username: string, password: string): Promise<string[]> {
  // Launch the browser
...
await page.waitForNavigation();
  ...
  await page.goto(`${domain}courses/${course}/quizzes/${quiz_id}/history?quiz_submission_id=${quiz_submission_id}`, {
