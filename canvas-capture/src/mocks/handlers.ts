...
const submissionsRawJSON = JSON.stringify([
    {
        id: 4,
...
const quizRawJSON = JSON.stringify({
    id: 4,
...
const quizSubmissionJSON = JSON.stringify({
    quiz_submissions: [
        {
            id: 2,
            quiz_id: 1,
